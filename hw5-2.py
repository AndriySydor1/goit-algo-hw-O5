...
def generator_numbers(text: str):
    ...
    # Використовуємо конструкцію yield для створення генератора
    for match in matches:
        yield float(match.group())

def sum_profit(text: str, func: Callable):
    # Використовуємо генератор для отримання чисел і підрахунку їх суми
    total_sum = sum(func(text))
    return total_sum

# Приклад використання:
text_example = "Income: 1000.01 Expenses: 27.45 Savings: 324.00"
